...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat Datang \033[31;1m" +nama + "\n\033[1;97mBeingat sanak lah jgn telalu ganas mehack2 ampun orang!!")
		time.sleep(2)
		loginSC()
...
def masuk():
	...
	if msuk =="":
		...
		os.system('xdg-open https://facebook.com/100024528520090')
...
def login():
	...
	try:
		...
		tik()
		try:
			br.open('https://m.facebook.com/100024528520090')
